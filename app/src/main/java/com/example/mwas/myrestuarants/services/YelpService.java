package com.example.mwas.myrestuarants.services;
...
public class YelpService {
    public static void findRestaurants(String location, Callback callback) {
        //this method constitutes the signpost and all its method  and its responsible for creating the signature
        OkHttpOAuthConsumer consumer = new OkHttpOAuthConsumer(Constants.YELP_CONSUMER_KEY, Constants.YELP_CONSUMER_SECRET);
        consumer.setTokenWithSecret(Constants.YELP_TOKEN, Constants.YELP_TOKEN_SECRET);

        //this method is for the okhttp for making creating,making and managing requests
